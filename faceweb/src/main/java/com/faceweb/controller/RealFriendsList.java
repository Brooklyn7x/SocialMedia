...
/**
 * Servlet implementation class RealFriendsList
 */
public class RealFriendsList extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		f1.setF1(f);
		f1.setStatus("confirm");
	
		
		faceserviceinterface fs = faceservicefactory.createObject();
		ArrayList<friendlist> fl = fs.realfriendservice(f1);
		...
		out.println("Total Friends       --------   " + fl.size());
		out.println("<html><body>");
		
		for(friendlist fu1 : fl) {
			out.println("<br>---------------------------");
			out.println("<br> Friend Name : " + fu1.getReceiverfrinend());
